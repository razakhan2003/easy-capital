export const products = [
  {
    show: true,
    name: "Secured Term Business Loan Terms",
    slug: "secured-term-loans",
    tagline: "Be The Catalyst For Entrepreneurial Success",
    description:
    ...
    quries: [
      {
        head: "What are the risks of taking a Secured Term Loan?",
        discription:
      ...
      {
        head: "What are the benefits of a Secured Term Loan?",
        discription:
      ...
      {
        head: "When to apply for a Secured Term Loan?",
        discription:
  ...
  },
  {
    ...
    tagline:
      "Empowering Your Growth: Flexible Financing for Equipment and Machinery",
    description:
    ...
    quries: [
      {
        head: "What are the risks of taking a Machinery Loan / Equipment Loan?",
        discription:
      ...
      {
        head: "What are the benefits of taking an Equipment or Machinery Loan?",
        discription:
      ...
      {
        head: "Can I get a Machinery Loan without Collateral?",
        discription:
  ...
  },
  {
    ...
    quries: [
      {
        head: "What are the risks of taking a Loan Against Property?",
        discription:
      ...
      {
        head: "What are the benefits of a Loan Against Property?",
        discription:
      ...
      {
        head: "When is the best time to apply for a Loan Against Property?",
        discription:
  ...
  },
  {
    ...
    quries: [
      {
        head: "What are the risks of getting a Cash Credit Loan for SMEs?",
        discription:
      ...
      {
        head: "What are the benefits of getting a Cash Credit Loan for SMEs?",
        discription:
      ...
      {
        head: "What is the best use of a Cash Credit Loan for SMEs?",
        discription:
  ...
  },
  {
    ...
    quries: [
      {
        head: "What are the risks of a Working Capital Loan?",
        discription:
      ...
      {
        head: "What are the benefits of a Working Capital Loan?",
        discription:
      ...
      {
        head: "When should I apply for a Working Capital Loan?",
        discription:
  ...
  },
  {
    ...
    tagline:
      "Stay Ahead: Flexible Overdraft Solutions for Your Financial Needs",
    description:
    ...
    quries: [
      {
        head: "What are the risks of taking an Overdraft Facility?",
        discription:
      ...
      {
        head: "What are the benefits of an taking an Overdraft Loan?",
        discription:
      ...
      {
        head: "How should I use my OD limit to help my small business finances?",
        discription:
    ...
    image: "/images/products/overdraft.svg",
  },
  {
    name: "Line Of Credit",
    slug: "line-of-credit",
    tagline: "Flexibility Meets Opportunity, Unlock potential",
    description:
      "Easy Capital offers Credit Lines designed to meet your dynamic financial needs. With flexible limits and convenient access, our Credit Lines provide the liquidity to seize opportunities swiftly.",
    image: "/images/products/credit-line.svg",
  },
  {
    name: "MSME Loan",
    slug: "msme-loan",
    tagline: "Empower Your Dreams",
    description:
      "Easy Capital provides accessible MSME loans tailored to small and medium enterprises, enabling growth and financial stability with hassle-free financing solutions.",
    image: "/images/products/term-loan.svg",
  },
  {
    name: "Secured Business Loan",
    slug: "secured-business-loan",
    tagline: "Your Bridge To Financial Fluidity",
    description:
      "Easy Capital offers flexible business loans designed to support enterprises of all sizes, providing quick access to capital for expansion, operations, and investment needs.",
    image: "/images/products/invoice-loan.svg",
  },
  {
    name: "Machinery Loan",
    slug: "machinery-loan",
    tagline: "Fueling Your Industrial Evolution",
    description:
      "Easy Capital's Machinery Loans are tailored to fuel your industrial ambitions. With competitive rates and flexible terms, we provide the capital needed to acquire essential equipment.",
    image: "/images/products/machinery-loan.svg",
  },
  {
    name: "Business Loan for Women",
    slug: "business-loan-for-women",
    tagline: "Fostering Independence And Success For All",
    description:
      "Easy Capital's Women Loans are crafted to empower female entrepreneurs. With competitive rates and tailored terms, we offer accessible capital to fuel your business aspirations.",
    image: "/images/products/women-loan.svg",
  },
  {
    name: "Business Ecommerce Loan",
    slug: "business-ecommerce-loan",
    tagline: "Accelerate Your Online Business Journey",
    description:
      "Easy Capital's Ecommerce Loans are designed to propel your online business forward. With competitive rates and customized terms, we provide accessible capital to drive growth in the digital marketplace.",
    image: "/images/products/ecommerce-loan.svg",
  },
  {
    name: "Loan Against Property For Business",
    slug: "loan-against-property",
    tagline: "Freedom To Thrive",
    description:
      "Easy Capital offers convenient loan against property solutions, providing property owners with access to substantial funds while leveraging their assets for various financial needs with ease and convenience.",
    image: "/images/products/unsecure-loan.svg",
  },
];
