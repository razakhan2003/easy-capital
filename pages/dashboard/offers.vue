<template>
    <div>
        <h2 class="text-[2rem] font-bold mb-10">Choose from our curated list of offers from our lenders :</h2>
...
export default{
  data(){
    return{
      lenders: [
        ...
        {name: 'IIFL Finance', status: 'Application Incomplete', roi: "17-25% PA", pf: "Upto 2-6%", loan_amount: "Upto 30 Lakh", date: "Not Applied", image: '/images/logos/iifl-finance.png'},
  ...
  methods: {
    parseData(){
      ...
      Cookies.set("offers", lenders, { expires: 15 });
    },
    unparseData(){
      if(Cookies.get("offers")){
        this.lenders = JSON.parse(Cookies.get("offers"));
      }
    },
    async apply(index){
